...
const features=[
  ...
  ['✦','İÇERİK','Akıllı İçerik Stüdyosu','Dosyadan kart, test, slayt, infografik, sesli anlatım ve benzer soru üretir.'],
...
export default function FeaturesPage(){
  return <PortalShell
    ...
    description="Her modül aynı öğrenci verisini besler; test sonucu, çalışma tekniği, hedef ve içerik kullanımı birbirinden kopuk kalmaz."
  >
