...
export default async function StudentPage() {
  ...
  >
    ...
    <section className="section"><PortalSectionTitle eyebrow="ÖN GÖRÜŞME" title="Açık Uçlu Çalışma Davranışı ve Planlama Formu" description="Eğilim taraması tamamlanınca eğitim ve gelişim düzeyinize uygun açık uçlu form otomatik açılır. Cevaplarınızla birlikte 1 yıllık, aylık, haftalık ve günlük plan taslağı oluşturulur; yönetici onayından sonra koçunuza gönderilir."/><StudentPreInterview/></section>
  </PortalShell>;
}
