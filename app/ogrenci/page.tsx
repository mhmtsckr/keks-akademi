...
export default async function StudentPage() {
  ...
  >
    ...
    <section className="section"><PortalSectionTitle eyebrow="ÖN GÖRÜŞME" title="Çalışma Davranışı ve Planlama Formu" description="Eğilim taraması yönetici tarafından onaylandıktan sonra bu form otomatik açılır. Ön görüşme tamamlanınca yıllık, aylık, haftalık ve günlük plan taslağı yönetici onayına gider."/><StudentPreInterview/></section>
  </PortalShell>;
}
